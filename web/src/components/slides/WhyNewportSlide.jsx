...
function HeroCard({ pillar }) {
  ...
  return (
    <motion.div
      ...
      className="row-span-2 rounded-xl bg-white p-10 shadow-sm border border-zinc-200 flex flex-col justify-center relative overflow-hidden"
    >
      {/* Gold accent strip */}
      ...
      <div className="pl-4">
        ...
        <div className="flex items-baseline gap-3 mb-2">
          <span className="font-body text-6xl font-semibold tracking-tighter leading-none" style={{ color: '#C9A84C' }}>
            {pillar.stat}
          </span>
        ...
        <div className="flex items-center gap-2 mt-5 pt-5 border-t border-zinc-100">
          <span className="font-body text-xs font-medium text-zinc-400">Since 1991</span>
          <span className="text-zinc-300">·</span>
          <span className="font-body text-xs font-medium text-zinc-400">Plantation, FL</span>
        </div>
      </div>
    </motion.div>
  )
...
function StatCard({ pillar, index }) {
  ...
  return (
    <motion.div
      ...
      className="rounded-xl bg-white p-6 shadow-sm border border-zinc-200 flex flex-col justify-center"
    >
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-baseline gap-2 mb-1">
            <span
              className="font-body text-2xl font-semibold tracking-tight leading-none"
  ...
  return (
    <div className="w-full h-full flex flex-col justify-center px-20 pb-16 relative overflow-hidden">
      ...
      <div className="mb-6 relative z-10">
        ...
        >
          A 35-year track record can't be manufactured. In the current post-fraud environment,
      ...
      <div className="grid grid-cols-[1fr_1fr] grid-rows-[1fr_1fr_1fr] gap-4 relative z-10" style={{ height: '460px' }}>
